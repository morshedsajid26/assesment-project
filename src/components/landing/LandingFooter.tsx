...
export const LandingFooter: React.FC = () => {
  ...
  return (
    <footer className="border-t border-slate-200/80 dark:border-zinc-800/80 bg-white dark:bg-zinc-950 py-8 relative z-10 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-3">
            ...
            <span className="font-extrabold text-sm tracking-tight text-zinc-900 dark:text-zinc-100 mr-2">
              ChatApp
            </span>
          ...
          <div className="flex items-center gap-4 text-zinc-400 dark:text-zinc-500">
            <Link href="#" className="hover:text-zinc-900 dark:hover:text-white transition-colors p-2 hover:bg-slate-100 dark:hover:bg-zinc-800 rounded-full">
          ...
          <div className="flex items-center gap-2 text-xs text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-500/10 px-3 py-1.5 rounded-full font-medium border border-emerald-200 dark:border-emerald-500/20">
