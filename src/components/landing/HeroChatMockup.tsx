...
export const HeroChatMockup: React.FC = () => {
  ...
  return (
    <div className="mt-16 lg:mt-24 relative max-w-5xl mx-auto">
      ...
      <div className="absolute -inset-2 bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-600 rounded-[36px] blur-2xl opacity-50 dark:opacity-30 animate-pulse pointer-events-none" />
      ...
      <motion.div
        ...
        className="hidden sm:flex absolute -top-7 -left-6 z-30 items-center gap-2.5 px-4 py-2.5 rounded-2xl bg-white/95 dark:bg-zinc-900/95 backdrop-blur-2xl border border-emerald-500/50 dark:border-emerald-500/40 shadow-[0_15px_35px_-5px_rgba(16,185,129,0.25)] ring-1 ring-emerald-500/20 select-none"
      >
      ...
      <motion.div
        ...
        className="hidden sm:flex absolute -top-7 -right-6 z-30 items-center gap-2.5 px-4 py-2.5 rounded-2xl bg-white/95 dark:bg-zinc-900/95 backdrop-blur-2xl border border-indigo-500/50 dark:border-indigo-500/40 shadow-[0_15px_35px_-5px_rgba(99,102,241,0.25)] ring-1 ring-indigo-500/20 select-none"
      >
      ...
      <motion.div
        ...
        className="hidden sm:flex absolute -bottom-7 -right-6 z-30 items-center gap-2.5 px-4 py-2.5 rounded-2xl bg-white/95 dark:bg-zinc-900/95 backdrop-blur-2xl border border-blue-500/50 dark:border-blue-500/40 shadow-[0_15px_35px_-5px_rgba(59,130,246,0.25)] ring-1 ring-blue-500/20 select-none"
      >
