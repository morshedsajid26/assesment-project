...
export const BentoFeatures: React.FC = () => {
  return (
    <section
      id="features"
      className="py-24 md:py-32 relative z-10 scroll-mt-20"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 md:mb-20">
          ...
          >
            Engineered with modern web standards, ultra-low latency WebSockets,
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            <div className="relative z-10 max-w-lg">
              ...
              <p className="mt-3 text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed">
                Powered by Socket.IO and TanStack Query with optimistic
                mutations. Messages arrive instantly across all connected
                clients with zero manual polling or delay.
              </p>
            </div>
            ...
            <div className="mt-8 pt-6 border-t border-blue-200/50 dark:border-zinc-800/80 flex flex-wrap items-center gap-3">
              <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white/90 dark:bg-zinc-800 text-xs font-semibold text-zinc-800 dark:text-zinc-200 border border-slate-200/80 dark:border-zinc-700/60 shadow-2xs">
                <Check className="w-3.5 h-3.5 text-emerald-500" /> Optimistic
                Updates
              </span>
              <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white/90 dark:bg-zinc-800 text-xs font-semibold text-zinc-800 dark:text-zinc-200 border border-slate-200/80 dark:border-zinc-700/60 shadow-2xs">
                <Check className="w-3.5 h-3.5 text-emerald-500" /> Instant
                Fallback Sync
              </span>
              <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white/90 dark:bg-zinc-800 text-xs font-semibold text-zinc-800 dark:text-zinc-200 border border-slate-200/80 dark:border-zinc-700/60 shadow-2xs">
                <Check className="w-3.5 h-3.5 text-emerald-500" /> Chronological
                Auto-Sort
              </span>
            </div>
          </motion.div>
          ...
          >
            <div>
              ...
              <p className="mt-3 text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed">
                Create multi-user groups with full admin hierarchy. Promote
                members, remove users with modal confirmations, and rename
                channels seamlessly.
              </p>
            </div>
          ...
          >
            <div>
              ...
              <p className="mt-3 text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed">
                No passwords to remember. Instant access with phone and display
                name. Automatically provisions new accounts on the fly.
              </p>
            </div>
          ...
          >
            <div className="relative z-10 max-w-lg">
              ...
              <p className="mt-3 text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed">
                Class-based dark and light modes with custom high-contrast
                scrollbars. Smart auto-scroll pins latest messages to the bottom
                while respecting user history reading.
              </p>
            </div>
            ...
            <div className="mt-8 pt-6 border-t border-violet-200/50 dark:border-zinc-800/80 flex flex-wrap items-center gap-3">
              ...
              <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white/90 dark:bg-zinc-800 text-xs font-semibold text-zinc-800 dark:text-zinc-200 border border-slate-200/80 dark:border-zinc-700/60 shadow-2xs">
                <Smartphone className="w-3.5 h-3.5 text-indigo-500" /> 100%
                Mobile Responsive
              </span>
            </div>
          </motion.div>
